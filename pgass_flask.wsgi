"""
  ...
  Use this for running the PGaaS service from Apache.
  ...
  Required steps for mod-wsgi implementation:
   ...
   1) Configure apache config (/etc/httpd/conf/httpd.conf) with this section:
      <IfModule wsgi_module>
         ...
         WSGIScriptAlias /pgass /home/wfanselow/pGaaS/pgaas_flask.wsgi
         ## Configure directoty-access to <app>.wsgi for apache
         <Directory /home/wfanselow/PgaaS>
...
## Set location of the <flask_app>.py directory (does not have to be current dir)
BASE_DIR = '/home/wfanselow/pGaaS/app'
...
from app.pgaas_flask import app as application
